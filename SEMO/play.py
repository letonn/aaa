...
async def play(client: Client, message):
  ...
  if not message.reply_to_message:
     ...
     await rep.delete()
       ...
       photo = "Uploaded to https://telegra.ph/file/75737308889fade2c982a.jpg"
